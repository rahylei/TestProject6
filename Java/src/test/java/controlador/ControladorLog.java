...
public class ControladorLog {
    ...
    private static MenuPrincipalUsuario menuUsuario;
    ...
    public static void moduloLog() {
        log = new Login();
        log.setVisible(true);
        log.ingresar.addActionListener(new ActionListener() {
    ...
    //Funcion para la seleccion de interfaces
    ...
    public static void moduloMenuUsuario() {
        menuUsuario = new MenuPrincipalUsuario();
